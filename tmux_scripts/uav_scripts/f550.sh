...
pre_input="export UAV_NAME=$UAV_NAME; export ATHAME_ENABLED=0; mkdir -p $MAIN_DIR/$PROJECT_NAME;"
...
'
  'Control' "waitForOdometry; roslaunch mrs_uav_manager f550.launch
"
  ...
  'EdgeDetect' "waitForControl; roslaunch vision_example uav.launch
"
  'WaypointFlier' "waitForControl; roslaunch waypoint_flier uav.launch
"
  'FlyToFirst' "rosservice call /$UAV_NAME/waypoint_flier/fly_to_first_waypoint"
  'Start' "rosservice call /$UAV_NAME/waypoint_flier/start_waypoints_following"
  'Stop' "rosservice call /$UAV_NAME/waypoint_flier/stop_waypoints_following"
  'ChangeEstimator' "rosservice call /$UAV_NAME/odometry/change_estimator_type_string RTK"
  'Constraints' "rosservice call /$UAV_NAME/constraint_manager/set_constraints fast"
